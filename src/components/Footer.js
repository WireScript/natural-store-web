    ...
    <footer className="bg-[#2E7D32] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">NaturalStore</h3>
            <p className="text-white/80">
              Your trusted source for premium organic products and sustainable living.
            </p>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="px-4 py-2 rounded bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-white"
              />
              <button
                type="submit"
                className="bg-white text-[#2E7D32] px-4 py-2 rounded font-semibold hover:bg-white/90 transition-colors"
              >
                Subscribe
              </button>
            </form>
