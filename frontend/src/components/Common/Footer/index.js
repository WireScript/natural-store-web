        ...
        <div className={styles.FooterGrid}>
          ...
          <div className={styles.FooterLinks}>
            <div className={styles.FooterLinkGroup}>
              <h3 className={styles.FooterLinkGroupTitle}>Quick Links</h3>
            ...
            <div className={styles.FooterLinkGroup}>
              <h3 className={styles.FooterLinkGroupTitle}>Customer Service</h3>
          ...
          <div className={styles.FooterNewsletter}>
            <h3 className={styles.FooterNewsletterTitle}>Newsletter</h3>
            ...
            <form className={styles.FooterNewsletterForm}>
              ...
              />
              <button type="submit" className={styles.FooterNewsletterButton}>
                Subscribe
              </button>
            </form>
          </div>
